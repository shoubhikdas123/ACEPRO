...
export function ExpertMentorCTA() {
  return (
    <section className="container  mx-auto my-32  py-12">
      <div className="relative h-auto md:h-[180px] flex flex-col md:flex-row justify-end bg-amber-100 dark:bg-neutral-800 rounded-2xl shadow-sm py-2 md:py-0">
        {/* Image Container
        ...
        */}
        <div className="absolute  top-0 sm:top-[-2px] md:top-[-110px] overflow-hidden left-4 sm:left-8 md:left-12 w-24 sm:w-32 md:w-52 lg:h-24 sm:h-[105px] md:h-auto">
          {/* Background Circle */}

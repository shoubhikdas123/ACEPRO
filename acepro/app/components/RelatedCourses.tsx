...
const coursesData = [
  {
    id: 1,
    imageUrl: "https://images.unsplash.com/photo-1542744173-8e7e53415254?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80", // Placeholder image
    tags: [
      { text: "Live Classes", className: "bg-blue-100 text-blue-700 border-blue-200" },
      { text: "Instructor Led Sessions", className: "bg-red-100 text-red-700 border-red-200" },
    ],
 ...
 * A component to display a grid of related course cards.
 * Uses React, TailwindCSS, and shadcn/ui components.
 */
